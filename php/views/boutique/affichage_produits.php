...
<a class="addToCart" onclick="ajoutPanier('.($user instanceof Utilisateur ? $user->getId() : 0).','.$produit->getId().')"><i id="inputAjoutPanier'.$produit->getId().'" class="fa fa-cart-plus" aria-hidden="true"></i></a><br>
